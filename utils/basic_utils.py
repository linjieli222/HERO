'''
Basic util functions copied from TVRetrieval implementation
...
def flat_list_of_lists(in_list):
...
def make_zipfile(src_dir, save_path, enclosing_dir="", exclude_dirs=None,
