...
# finetuned
wget $BLOB/finetune/tvr_default.tar -P $DOWNLOAD/finetune/
tar -xvf $DOWNLOAD/finetune/tvr_default.tar -C $DOWNLOAD/finetune --strip-components 1
rm $DOWNLOAD/finetune/tvr_default.tar
